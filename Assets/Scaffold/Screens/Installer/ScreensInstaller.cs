...
#if !USE_SCAFFOLD_SCREENS || !USE_SCAFFOLD_EVENTS
namespace Scaffold.Screens.Installer
{
    internal class ScreensInstaller
    {
        private static string LauncherDefine = "USE_SCAFFOLD_LAUNCHER";
        private static string LauncherSkipKey = "LAUNCHERSKIPSCREENS";
        private static string ValidationKey = "PROJECTVALIDATED";

        private static readonly string[] RequiredDefines = { "USE_SCAFFOLD_SCREENS", "USE_SCAFFOLD_EVENTS" };
        private static readonly string[] InstallDefines = { "USE_SCAFFOLD_SCREENS" };
